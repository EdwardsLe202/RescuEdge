...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    transcodingHint: "Preparing stream, this may take a moment",
    videoLoadError: "Could not load this video",
    clipLibrary: "Clip Library",
    clipLibraryDesc: "Recorded clips from this device — select one to play",
    latestBadge: "LATEST",
    nowPlaying: "NOW PLAYING",
    noClipsForDevice: "No recorded clips for this device yet",
    videoRecordings: "Video Recordings",
    videoRecordingsDesc: "All recorded clips from this device — click any clip to play it",
    realtimeStreamTitle: "Real-Time Alert Stream",
    realtimeStreamDesc: "Live incident & device events over WebSocket",
    liveLabel: "LIVE",
    disconnectedLabel: "OFFLINE",
    waitingForEvents: "Listening for live events…",
    eventIncident: "Incident detected",
    eventStatusChanged: "Device status changed",
    justNow: "just now",
  ...
  vi: {
    ...
    transcodingHint: "Đang chuẩn bị luồng video, vui lòng đợi giây lát",
    videoLoadError: "Không thể tải video này",
    clipLibrary: "Thư viện video",
    clipLibraryDesc: "Các đoạn video đã ghi từ thiết bị này — chọn để phát",
    latestBadge: "MỚI NHẤT",
    nowPlaying: "ĐANG PHÁT",
    noClipsForDevice: "Thiết bị này chưa có video nào",
    videoRecordings: "Bản ghi video",
    videoRecordingsDesc: "Tất cả video đã ghi từ thiết bị này — bấm vào clip để xem",
    realtimeStreamTitle: "Luồng cảnh báo thời gian thực",
    realtimeStreamDesc: "Sự kiện sự cố & thiết bị trực tiếp qua WebSocket",
    liveLabel: "TRỰC TIẾP",
    disconnectedLabel: "MẤT KẾT NỐI",
    waitingForEvents: "Đang lắng nghe sự kiện trực tiếp…",
    eventIncident: "Phát hiện sự cố",
    eventStatusChanged: "Thiết bị đổi trạng thái",
    justNow: "vừa xong",
