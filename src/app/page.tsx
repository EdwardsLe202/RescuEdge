...
export default function Home() {
  ...
  // Video Canvas Mock Drawing Loop (Fallback when streamUrl is null)
  useEffect(() => {
    if (streamUrl) return; // Don't run simulation if live stream is active
    ...
    const render = () => {
      ...
      ctx.fillRect(ClerkX + 45, ClerkY - 25, 25, 20);

      ctx.fillStyle = "#e2b694";
      ctx.beginPath();
      ...
      ctx.fillText(`CAM: ${selectedDeviceId || "DEV-MODE"}`, 20, 30);
  ...
  }, [isPlaying, currentTime, streamUrl, selectedDeviceId]);
  ...
  }, [isPlaying, playbackSpeed, streamUrl]);
